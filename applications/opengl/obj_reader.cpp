...
void ObjReader::ParseLinebuf(const char* linebuf, std::vector<uint32_t> &vIndex,
	std::vector<uint32_t> &vtIndex, std::vector<uint32_t> &vnIndex)
{
	// 计算字符串中有几组数据
